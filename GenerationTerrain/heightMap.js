// battles/terrain/noise/heightMap.js

/**
 * Генерирует детерминированную height map
 * @param {number} width
 * @param {number} height
 * @param {Object} options
 * @returns {Uint8Array} heights (0–99)
 */
export function generateHeightMap(
    ...
    for (let i = 0; i < result.length; i++) {
        const normalized = (result[i] - min) / range;
        heights[i] = Math.round(normalized * 99);
    }
